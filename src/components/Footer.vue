...
<template>
  ...
  <footer>
    ...
    mt-20 h-96">
      <div class="col-span-10 col-start-2 pt-50">
        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
              <a class="flex items-center" href="">
                <img alt="Logo"
                     class="h-56 mr-3" src="../assets/images/LogoSloganWhite.svg"/>
              </a>
            </div>
          ...
          <div class="sm:flex sm:items-center sm:justify-end">
            <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              ...
              <a class="text-gray-500 hover:text-gray-900 " href="#">
                <svg aria-hidden="true" class="w-4 h-4" fill="currentColor" viewBox="0 0 21 16"
                     xmlns="http://www.w3.org/2000/svg">
                  <path
